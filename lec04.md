...
<text x="34" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">contexto</text>
<text x="141" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">hidden</text>
<text x="252" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">predição</text>
...
<text x="36" y="150" text-anchor="middle" fill="#93c5fd" font-size="8" font-family="sans-serif">central</text>
...
<text x="36" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">central</text>
<text x="141" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">hidden</text>
<text x="252" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">predição</text>
</svg>

<div class="text-[10px] leading-snug mt-1 px-2 py-1.5 rounded bg-slate-800/60 border border-slate-600/40 text-slate-400">
💡 <span class="text-slate-300 font-semibold">Negative Sampling</span> — evita softmax sobre |V|: classifica (w, ctx) como par real ou aleatório usando k ≈ 5–20 negativos por passo → O(k) em vez de O(|V|)
</div>
