...
**Função objetivo do Skip-gram**

Maximizar a probabilidade log-conjunta dos contextos:
...
O softmax sobre $|\mathcal{V}|$ é caro — usa-se **negative sampling**: distinguir o contexto real de $k$ amostras negativas aleatórias.
