...
<svg viewBox="0 0 300 205" xmlns="http://www.w3.org/2000/svg" class="w-full">
<defs>
<marker id="arr4" markerWidth="5" markerHeight="5" refX="4" refY="2.5" orient="auto">
<path d="M0,0 L5,2.5 L0,5 Z" fill="#475569"/>
</marker>
</defs>
<text x="150" y="12" text-anchor="middle" fill="#94a3b8" font-size="10" font-weight="bold" font-family="sans-serif">CBOW</text>
<rect x="4" y="18" width="60" height="16" rx="3" fill="#1e3a5f" stroke="#3b82f6" stroke-width="0.8"/>
<text x="34" y="30" text-anchor="middle" fill="#93c5fd" font-size="9" font-family="monospace">w_{t-2}</text>
<rect x="4" y="37" width="60" height="16" rx="3" fill="#1e3a5f" stroke="#3b82f6" stroke-width="0.8"/>
<text x="34" y="49" text-anchor="middle" fill="#93c5fd" font-size="9" font-family="monospace">w_{t-1}</text>
<rect x="4" y="56" width="60" height="16" rx="3" fill="#1e3a5f" stroke="#3b82f6" stroke-width="0.8"/>
<text x="34" y="68" text-anchor="middle" fill="#93c5fd" font-size="9" font-family="monospace">w_{t+1}</text>
<rect x="4" y="75" width="60" height="16" rx="3" fill="#1e3a5f" stroke="#3b82f6" stroke-width="0.8"/>
<text x="34" y="87" text-anchor="middle" fill="#93c5fd" font-size="9" font-family="monospace">w_{t+2}</text>
<line x1="64" y1="26" x2="112" y2="56" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="64" y1="45" x2="112" y2="58" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="64" y1="64" x2="112" y2="60" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="64" y1="83" x2="112" y2="62" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<rect x="114" y="48" width="54" height="26" rx="4" fill="#3b0764" stroke="#8b5cf6" stroke-width="1"/>
<text x="141" y="63" text-anchor="middle" fill="#c4b5fd" font-size="9" font-family="sans-serif">W(V×d)</text>
<line x1="168" y1="61" x2="210" y2="61" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<rect x="212" y="49" width="80" height="24" rx="3" fill="#134e4a" stroke="#10b981" stroke-width="0.8"/>
<text x="252" y="59" text-anchor="middle" fill="#6ee7b7" font-size="9" font-family="monospace">w_t</text>
<text x="252" y="69" text-anchor="middle" fill="#6ee7b7" font-size="8" font-family="sans-serif">softmax</text>
<text x="34" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">context</text>
<text x="141" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">hidden</text>
<text x="252" y="101" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">prediction</text>
<line x1="4" y1="108" x2="296" y2="108" stroke="#1e293b" stroke-width="1.5"/>
<text x="150" y="120" text-anchor="middle" fill="#94a3b8" font-size="10" font-weight="bold" font-family="sans-serif">Skip-gram</text>
<rect x="4" y="128" width="64" height="26" rx="3" fill="#1e3a5f" stroke="#3b82f6" stroke-width="0.8"/>
<text x="36" y="139" text-anchor="middle" fill="#93c5fd" font-size="9" font-family="monospace">w_t</text>
<text x="36" y="150" text-anchor="middle" fill="#93c5fd" font-size="8" font-family="sans-serif">center</text>
<line x1="68" y1="141" x2="112" y2="141" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<rect x="114" y="129" width="54" height="26" rx="4" fill="#3b0764" stroke="#8b5cf6" stroke-width="1"/>
<text x="141" y="144" text-anchor="middle" fill="#c4b5fd" font-size="9" font-family="sans-serif">W(V×d)</text>
<line x1="168" y1="137" x2="210" y2="125" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="168" y1="140" x2="210" y2="138" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="168" y1="143" x2="210" y2="152" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<line x1="168" y1="146" x2="210" y2="166" stroke="#475569" stroke-width="0.8" marker-end="url(#arr4)"/>
<rect x="212" y="117" width="80" height="16" rx="3" fill="#134e4a" stroke="#10b981" stroke-width="0.8"/>
<text x="252" y="128" text-anchor="middle" fill="#6ee7b7" font-size="9" font-family="monospace">w_{t-2}</text>
<rect x="212" y="136" width="80" height="16" rx="3" fill="#134e4a" stroke="#10b981" stroke-width="0.8"/>
<text x="252" y="147" text-anchor="middle" fill="#6ee7b7" font-size="9" font-family="monospace">w_{t-1}</text>
<rect x="212" y="155" width="80" height="16" rx="3" fill="#134e4a" stroke="#10b981" stroke-width="0.8"/>
<text x="252" y="166" text-anchor="middle" fill="#6ee7b7" font-size="9" font-family="monospace">w_{t+1}</text>
<rect x="212" y="174" width="80" height="16" rx="3" fill="#134e4a" stroke="#10b981" stroke-width="0.8"/>
<text x="252" y="185" text-anchor="middle" fill="#6ee7b7" font-size="9" font-family="monospace">w_{t+2}</text>
<text x="36" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">center</text>
<text x="141" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">hidden</text>
<text x="252" y="200" text-anchor="middle" fill="#64748b" font-size="8" font-family="sans-serif">prediction</text>
</svg>

<div class="text-[10px] leading-snug mt-1 px-2 py-1.5 rounded bg-slate-800/60 border border-slate-600/40 text-slate-400">
💡 <span class="text-slate-300 font-semibold">Negative Sampling</span> — avoids softmax over |V|: classifies (w, ctx) as real or random using k ≈ 5–20 negatives per step → O(k) instead of O(|V|)
</div>
...
**Problem with Word2Vec/GloVe:** each word has a single vector — out-of-vocabulary (OOV) words get no representation.

**FastText idea** (Bojanowski et al., 2017):  
instead of one vector per word, learn vectors for **character n-grams**.
...
"where"  →  n-grams (n=3):
  <wh, whe, her, ere, re>
  + the whole token <where>

vector("where") = Σ n-gram vectors
```
...
✅ **OOV:** "whereabouts" unseen → compose from known n-grams  
✅ **Morphology:** "run", "running", "runner" share n-grams  
✅ **Noise/typos:** "teh" ≈ "the" via overlapping n-grams
...
<div class="text-slate-400">Unit</div><div class="text-center">word</div><div class="text-center">char n-gram</div>
</div>
<div class="grid grid-cols-3 gap-1 py-1 border-b border-slate-800">
<div class="text-slate-400">OOV</div><div class="text-center text-red-400">❌ no vector</div><div class="text-center text-emerald-400">✅ compose</div>
</div>
<div class="grid grid-cols-3 gap-1 py-1 border-b border-slate-800">
<div class="text-slate-400">Morphology</div><div class="text-center text-red-400">❌ ignored</div><div class="text-center text-emerald-400">✅ captured</div>
</div>
<div class="grid grid-cols-3 gap-1 py-1 border-b border-slate-800">
<div class="text-slate-400">Speed</div><div class="text-center text-emerald-400">✅ fast</div><div class="text-center text-amber-400">⚠ slower</div>
</div>
<div class="grid grid-cols-3 gap-1 py-1">
<div class="text-slate-400">Size</div><div class="text-center text-emerald-400">✅ smaller</div><div class="text-center text-amber-400">⚠ larger</div>
</div>
</div>

<div class="mt-3 p-2 rounded bg-indigo-900/30 border border-indigo-500/30 text-xs">

**In practice:** FastText excels in **morphologically rich languages** (Portuguese, German, Finnish) and noisy text (social media). Pre-trained vectors available for 157 languages at [fasttext.cc](https://fasttext.cc).
...
ft.get_word_vector("running")   # OOV? doesn't matter
```
